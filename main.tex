...
\newthought{Tugas Kelompok Praktikum} \\
\begin{enumerate}
\item Buatlah sebuah konfigurasi environment Big Data dengan beberapa Node sesuai dengan jumlah anggota dalam kelompok.
\item Jalankan program \textit{WordCount} dengan data yang telah di sediakan di \url{http://www.cs.biu.ac.il/~koppel/blogs/blogs.zip}. 
\item Buatlah Laporan tentang tugas praktikum tersebut dan perintah-perintah pada Hadoop dalam format PDF sesuai template yang diberikan di GitHub Classroom. 
